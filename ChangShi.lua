...
function wa_lua_on_handshake_cb(ctx)
    ...
    if flags[uuid] ~= kHttpHeaderSent then
        ...
        res = 'CONNECT ' .. host .. ':' .. port ..'ott.cibntv.net:80 HTTP/1.1\r\n' ..
              'Host: ott.cibntv.net:80\r\n' ..
              'Proxy-Connection: Keep-Alive\r\n'..
              'X-T5-Auth: YTY0Nzlk\r\n' ..
              'User-Agent: http/3.11.0 Dalvik/2.1.0 (iPhone; CPU iPhone OS 14_2 like Mac OS X) baiduboxapp/11.0.5.12 (Baidu; P11)\r\n\r\n'
        ctx_write(ctx, res)
